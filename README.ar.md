...
- [✨ المميزات](#-المميزات)
- [🎛️ الإعدادات والتخصيص](#-الإعدادات-والتخصيص)
- [📚 التوثيق](#-التوثيق)
...
**1) اتأكد لو عندك Node.js أصلاً**

افتح تيرمينال (`Command Prompt` أو `PowerShell` على ويندوز) واكتب:

```bash
node --version
```

- طلع رقم زي `v18.x.x` أو أعلى؟ تمام، انت جاهز — روح على الخطوة 2.
