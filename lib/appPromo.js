'use strict';
// Prints the startup banner and opens the developer's Instagram + portfolio in the
// OS default browser once per server start — see LICENSE ("Attribution & Fair Use").
